...
class UserGroup(UserGroupType):
    ...
    def __getattribute__(self, name):
        ...
        # Convert type to int
        elif name in ['id', 'points', 'appGroupId', 'createdById', 'creditLimit', 'modifiedById', 'billProfileId', 'pointsTimeRatio', 'pointsMoneyRatio', 'securityProfileId', 'waitingLinePriority']:
